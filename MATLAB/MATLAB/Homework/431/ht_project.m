...
% Initialize arrays
r2_values = start_value:step_size:stop_value;
Qbody_values = zeros(size(r2_values));
Ts_values = zeros(size(r2_values));
...
figure
plot(r2_values, Ts_values, 'r-')
xlabel('r2')
ylabel('Ts')
title('Variation of Ts with r2')
grid on
